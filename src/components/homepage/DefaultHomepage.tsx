// Default Homepage (Fallback when no configuration exists)
'use client';
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl md:text-2xl text-pink-100 mb-8 leading-relaxed">
                Mỗi chú gấu bông là một câu chuyện, một kỷ niệm đẹp. Tìm người bạn
                đồng hành hoàn hảo cho bạn và người thân yêu.
              </p>
